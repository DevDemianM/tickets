document.addEventListener('DOMContentLoaded', function() {
    ...
    if (partsTable) {
        ...
        // Configurar confirmación antes de enviar el formulario
        ...
        if (ticketForm) {
            ticketForm.addEventListener('submit', function(e) {
                ...
                Swal.fire({
                    ...
                    text: '¿Estás seguro de guardar los cambios en este ticket de reparación interna?',
                    icon: 'question',
                    showCancelButton: true,
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateTicketStatus(ticketId, newStatus, selectElement) {
        ...
        fetch('/tickets/update_ticket_status_ajax', {
            method: 'POST',
            headers: {
