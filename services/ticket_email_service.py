...
class TicketEmailService:
    ...
    def enviar_notificacion_reparacion(self, cliente, ticket, problemas, tecnico):
        ...
        :param cliente: Objeto cliente con atributos del SQL Server (nombre, apellido1, apellido2, email).
        ...
        try:
            ...
            destinatario = {
                "address": cliente.get('email'),
                "displayName": f"{cliente.get('nombre', '')} {cliente.get('apellido1', '')} {cliente.get('apellido2', '')}"
            }
    ...
    def _generar_contenido_html(self, cliente, ticket, problemas, tecnico):
        ...
        apellido_cliente = f"{cliente.get('apellido1', '')} {cliente.get('apellido2', '')}"
                ...
                <tr>
                    <td style="padding: 30px 25px;">
                        ...
                        <p style="font-size: 16px; line-height: 1.5; margin-bottom: 20px;">
                            Estimado(a) <strong>{nombre_cliente} {apellido_cliente}</strong>,
                        </p>
